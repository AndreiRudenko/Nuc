...
abstract FastMatrix3(kha.math.FastMatrix3) from kha.math.FastMatrix3 to kha.math.FastMatrix3 {
	...
	public inline function shear(x:FastFloat, y:FastFloat):FastMatrix3 {
	...
	public inline function setTransform(x:FastFloat, y:FastFloat, angle:FastFloat, sx:FastFloat, sy:FastFloat, ox:FastFloat, oy:FastFloat, kx:FastFloat, ky:FastFloat):FastMatrix3 {
